...
Cart mutation routes: remove seller, remove item, remove bucket, update quantities.

API endpoints extracted to:
- api.py: get_cart_sellers, can_refill_*, get_price_breakdown
"""
...
# Import extracted module to register API routes
from . import api  # noqa: F401 - registers API endpoints
